...
1. got clone REPO_URL
2. cd PROJECT_DIR
3. create .env with the variables available in .env.example
4. Run npm i to install all the dependencies.
5. Run prisma migrate dev --name init to run the prisma Schema file.
6. Run prisma db seed to run the seeder file.
